...
* System will display the Add New Media form.
	
	![Media add form](img/media-manual-add-form.png)
...
* You can select different types of media according to your library preference from the `Media Type` dropdown menu.
	...
	* Please select media type equals to `Other` while adding items other than books into your library catalog. 
...
* Then from the Detail tab you can enter the Volume no. also.
...
* Now scroll down to the E-Books section of the detail page.
